...
Widget _pageChrome(final BuildContext context) {
  final marginLeftRight = percentageOfScreenWidth(
      context,
      _PAGE_LEFT_RIGHT_MARGIN_PERCENT
  );
  return Stack(
    children: <Widget>[
      Container(
          ...
          padding: EdgeInsets.only(
              ...
              top: percentageOfScreenHeight(
                  context,
                  _PAGE_TOP_MARGIN_PERCENT
              ),
              right: marginLeftRight,
              bottom: percentageOfScreenHeight(
                  context,
                  _PAGE_BOTTOM_MARGIN_PERCENT
              )
          ),
          child: _PageContent()
      ),
          ...
          child: Row(
            ...
            children: <Widget>[
              Text('Built with Flutter',
                style: titleTextStyleFromContext(context).copyWith(
